...
trait Cloud
{
    ...
    public $cloud_host = 'app.ievtds.com';
    ...
    {
        if (! $this->isCloud()) {
            return 'https://ievtds.com/apps/roles?utm_source=software&utm_medium=' . $location . '&utm_campaign=roles';
        }
    ...
    {
        if (! $this->isCloud()) {
            return 'https://ievtds.com/apps/bank-feeds?utm_source=software&utm_medium=' . $location . '&utm_campaign=bank_feeds';
        }
