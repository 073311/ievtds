...
![Downloads](https://img.shields.io/packagist/dt/ievtds/laravel-sortable)
![Tests](https://img.shields.io/github/actions/workflow/status/ievtds/laravel-sortable/tests.yml?label=tests)
[![StyleCI](https://github.styleci.io/repos/442271942/shield?style=flat&branch=master)](https://styleci.io/repos/442271942)
[![License](https://img.shields.io/github/license/ievtds/laravel-sortable)](LICENSE.md)
...
```bash
composer require ievtds/laravel-sortable
```
