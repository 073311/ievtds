...
class Provider extends ServiceProvider
{
    ...
    {
        Blade::component('money', \ievtds\Money\View\Components\Money::class);
        Blade::component('currency', \ievtds\Money\View\Components\Currency::class);
    }
}
