...
use ievtds\Module\Exceptions\InvalidAssetPath;
use ievtds\Module\Exceptions\ModuleNotFoundException;
use ievtds\Module\Process\Installer;
use ievtds\Module\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @return string
     * @throws \ievtds\Module\Exceptions\ModuleNotFoundException
     */
