...
class ievtdsCollector extends DataCollector implements DataCollectorInterface, Renderable
{
    use Modules;
    ...
    public function collect()
    {
        ...
        $info = Info::all();
        $ievtds_version = ! empty($info['ievtds']) ? $info['ievtds'] : '0.0.0';
