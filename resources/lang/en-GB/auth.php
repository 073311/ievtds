...
return [
    ...
    'invitation' => [
        'message_1'         => 'You are receiving this email because you are invited to join the ievtds.',
    ...
    'information' => [
        ...
        'customize'         => 'Customize your ievtds',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'They get full access to your ievtds including customers, invoices, reports, settings, and apps.',
        ],
        'manager' => [
            'name'          => 'Manager',
            'description'   => 'They get full access to your ievtds, but can\'t manage users and apps.',
        ],
        'customer' => [
            'name'          => 'Customer',
